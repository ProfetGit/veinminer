...
- **Real vanilla drops.** Fortune, Silk Touch and XP work exactly as in vanilla, on every block of the vein.
- **Fair.** Each ore still needs the right pickaxe, every extra block costs durability (Unbreaking applies), and a vein never breaks your pickaxe.
...
- **You can** use Veinminer on any server, including monetized ones, include it in modpacks that credit Profet and link here, feature it in videos and modify it for your own world or server.
