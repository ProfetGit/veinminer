...
execute if score #anim veinminer.data matches 1 as @e[type=marker,tag=veinminer.new,limit=1] at @s run function veinminer:anim/setup with storage veinminer:op m
execute if score #anim veinminer.data matches 0 if score #xp veinminer.data matches 1.. run function veinminer:vein/drop_xp
